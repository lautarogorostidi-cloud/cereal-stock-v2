  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-campo-900">Stock de Fertilizantes</h1>
          <p className="text-campo-500 text-sm mt-0.5">Urea, fosfato, mezclas y demás fertilizantes — compras y stock disponible</p>
        </div>
        <a href="/fertilizantes/movimientos" className="btn-primary">+ Nuevo movimiento</a>
      </div>
